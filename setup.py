...
setup(name=NAME,
      ...
      install_requires=[
          "torch", "torchvision", "matplotlib", "Pillow>6.2.0", "pandas", "progressbar2", "six", "scipy>1.5", "slidingwindow","scikit-image","geopandas",'rasterio','rtree',"pytorch_lightning",
          "tqdm", "xmltodict", "numpy","imagecodecs"
      ],
      zip_safe=False)
