...
setup(name=NAME,
      ...
      install_requires=["keras > 2.3.0","keras-resnet==0.1.0","six","scipy","tensorflow==1.15.2","Pillow","pandas","opencv-python","pyyaml","slidingwindow","matplotlib","xmltodict","tqdm","progressbar2"],
