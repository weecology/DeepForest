...
def evaluate(
    ...
    Args:
        config (DictConfig): DeepForest config
    ...
    if ground_truth is None:
        ...
        print(f"Using validation CSV from config: {ground_truth}")
    ...
    if save_predictions is not None and predictions is None:
        ...
        print(
            "\nNote: --save-predictions is ignored when --predictions is provided (predictions already exist)"
        )
