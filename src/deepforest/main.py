...
>>>>>>> 79709690 (Refactor read_file to be more readable, consistent and fail early. This PR creates a custom class to close #1042, refactored to allow multiple image files to pass through)
            )
